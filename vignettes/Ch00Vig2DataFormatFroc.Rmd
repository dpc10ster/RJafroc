...
* That this is the *only* case with two marks determines the length of the fourth dimension of the `x$ratings$NL` list member, `r length(x$ratings$NL[1,1,1,])` in the current example. Absent this case, the length would have been one.
