...
```{r, echo=FALSE,out.width="50%",out.height="20%",fig.cap="Fig. 1: Two views of Truth worksheet for file frocSp.xlsx",fig.show='hold',fig.align='center'}
...
```{r, echo=FALSE,out.width="50%",out.height="20%",fig.cap="Fig. 2: NL/FP worksheet, left, and LL/TP worksheet, right, for file frocSp.xlsx",fig.show='hold',fig.align='center'}
