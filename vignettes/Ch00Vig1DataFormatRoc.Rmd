...
* Basically they are needed for generalization to other data collection paradigms instead of crossed, for example to split-plot data acquisition paradigm, and for better data entry error control.
...
* The `x$truthTableStr` member quantifies the structure of the dataset, as explained in **Chapter 00 Vignette #3**. **It is used to check for data entry errors.**
