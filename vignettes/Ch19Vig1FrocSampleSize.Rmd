...
For this dataset `Lmax` is 3, and `r relWeights[1]*100` percent of the diseased cases have one lesion, `r relWeights[2]*100` percent have two lesions and `r relWeights[3]*100` percent have three lesions. Since the lesions are equally weighted, on cases with one lesion the weight of the lesion is unity, on cases with two lesions the weights of each lesion is 0.5 and on cases with three lesions the weight of each lesion is 1/3.
