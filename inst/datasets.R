...
#' \itemize{
#' \item{\code{ratings}}{list of 3}
#' \item{\code{lesions}}{list of 3}
#' \item{\code{descriptions}}{list of 8}
#' }
#' \itemize{
#' \item{\code{ratings$NL}}{list of 3}
#' \item{\code{ratings$LL}}{list of 3}
#' \item{\code{ratings$LL_IL}}{NA}
#' }
#' ratings is a list with 3 elements
# \itemize{
# \item{NL} {ratings of non-lesion localizations, NLs}
# \item{LL} {ratings of non-lesion localizations, NLs}
# \item{LL_IL} {NA}}
# \item{\code{lesions}}{lesion characteristics}
...
# \item{\code{design}}{, chr "FCTRL", study design}
...
#' \item{\code{design}}{, "FCTRL", study design}
