...
#                       package = "RJafroc", mustWork = TRUE)
# x3 <- DfReadDataFile(rocSp, newExcelFileFormat = TRUE)
# 
# fom3 <- UtilFigureOfMerit(x3, FOM = "Wilcoxon")
# 
# rocSp2 <- system.file("extdata", "toyFiles/ROC/rocSpVaryK.xlsx",
#                       package = "RJafroc", mustWork = TRUE)
# x4 <- DfReadDataFile(rocSp2, newExcelFileFormat = TRUE)
# 
# fom4 <- UtilFigureOfMerit(x4, FOM = "Wilcoxon")
# 
